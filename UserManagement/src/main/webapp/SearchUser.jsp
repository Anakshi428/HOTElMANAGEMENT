   ...
   <div style="margin-top: -100px"class="search">
	...
	<div class="s-bar">
	   <form action="search" method="post">
		<input type="text" name="email" value="Search Your Profile" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search Template';}">
		<input type="submit"  value="Search"/>
	  </form>
	 </div></div>
 
 
 <table class="table table-hover table-dark" style="height:80%; width:80%; margin-left: auto;
