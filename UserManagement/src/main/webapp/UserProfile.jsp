...
<jsp:include page="/WEB-INF/view//Header.jsp"></jsp:include>
  ...
  background-position: center center ;border-radius: 50px;" ><br><br>
   <h1 class="h1" style="text-align: center">  User Profile</h1>
 ...
 <table class="table table-hover table-dark" style="height:50%; width:50%; margin-left: auto;
  ...
  <c:forEach var="user" items="${UserDetails}">
    ...
    <tr>
      ...
      <td class="bg-danger"style="border-radius: 25px 25px;">${user.userid}</td>
    </tr>
    
    <tr>
      <th scope="row">NAME</th>
      <td class="bg-danger"style="border-radius: 25px 25px;">${user.name}</td>
