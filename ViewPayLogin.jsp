...
<div Style="background-image:url('assets/images/b4.jpg'); background-repeat:no-repeat; background-attachment: fixed;
	...
	<div class="w3ls-login box box--big">
		...
		<form action="view" method="post">
			...
			<div class="w3ls-bot">
				...
				<div class="form-end">
					<input type="submit" value="view Details" Style="background-color: #2B547E; border: 2px solid #151B54">
				</div>
